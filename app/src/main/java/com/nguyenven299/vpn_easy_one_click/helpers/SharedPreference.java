...
public class SharedPreference {
    ...
    public Server getServer() {
        ...
        Server server = new Server(
                mPreference.getString(SERVER_COUNTRY,"VietNam"),
                mPreference.getString(SERVER_FLAG,getImgURL(de.blinkt.openvpn.R.drawable.ic_notification)),
                mPreference.getString(SERVER_OVPN,"vpngate.ovpn"),
